...
kinectfs: kinectfs.c
	gcc -g -o kinectfs kinectfs.c -I/usr/local/include/libfreenect -L/usr/local/lib -lixp -lfreenect -lm -DUSE_JPEG -ljpeg --std=c99 -DUSE_AUDIO #-DUSE_OGG -logg -lvorbis -lvorbisenc #-DUSE_PLAN9
